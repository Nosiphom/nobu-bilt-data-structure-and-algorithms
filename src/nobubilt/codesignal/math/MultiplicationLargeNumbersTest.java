...
public class MultiplicationLargeNumbersTest {

	  private MultiplicationLargeNumbers app;

	  @BeforeEach
	  void setUp() {
	    app = new MultiplicationLargeNumbers();
	  }
	  ...
	  void test11() {
	    Assertions.assertTimeoutPreemptively(Duration.ofMillis(200), () -> {
	      Assertions.assertEquals("699678", app.multiplyLargeNumbers("1234", "567"));
	    });
	  }
